...
class ResearchPolicy
{
    ...
    {
        return $user->can('view_any_research');
    }
    ...
    {
        return $user->can('update_research');
    }
    ...
    {
        return $user->can('delete_any_research');
    }
    ...
    {
        return $user->can('force_delete_research');
    }
    ...
    {
        return $user->can('force_delete_any_research');
    }
    ...
    {
        return $user->can('restore_research');
    }
    ...
    {
        return $user->can('restore_any_research');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, Research $research): bool
    {
        return $user->can('replicate_research');
    }
    ...
    {
        return $user->can('reorder_research');
    }
