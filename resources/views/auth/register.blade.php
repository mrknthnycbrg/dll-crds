    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input class="mt-1 block w-full" id="id_number" name="id_number"
                    type="text" :value="old('id_number')" required autofocus
            ...
            <div class="mt-4">
                ...
                <x-input class="mt-1 block w-full" id="password_confirmation"
                            ...
                            <div class="ml-2">
                                {!! __('I agree to the :terms_of_service and :privacy_policy', [
                                    'terms_of_service' =>
                                        ...
                                        route('terms.show') .
                                        '" class="underline text-sm text-gray-700 hover:text-blue-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-900">' .
                                        __('Terms of Service') .
                                        '</a>',
                                    'privacy_policy' =>
                                        '<a target="_blank" href="' .
